...
architecture behavioral of spi_rxtx_with_fifo is
	...
	constant FIFO_ALMOST_EMPTY_TRSH : integer := 1536;
	
	type fsmstatetype is (sIdle, sFirstByte, sFirstByteRdy, sRxData, sRxDataRdy, sTxData, sRstFIFO);
...
begin
	...
	ResetTxFIFORqdxSN <= '1' when ResetTxFIFOxSP = '0' and ResetTxFIFOxSI = '1' else
	...
	p_memless : process (StatexDP, CSnxSP, ResetTxFIFORqdxSP, SCKSRegxSP, BitCntxDP, FIFORdAddrxDP, FIFOEmptyxS, 
						FIFOBytesAvailableLtdxD, FIFOOutDataxD, TxSRegxDP, RxSRegxDP, MOSIRegxDP)
	begin
		MISOxDO <= 'Z';
		TxSRegxDN <= TxSRegxDP;
		RxSRegxDN <= RxSRegxDP;
