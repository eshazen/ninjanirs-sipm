...
-- Module  Version: 7.5
--C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n ram_a -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type bram -wp 11 -rp 1010 -data_width 9 -rdata_width 9 -num_rows 1024 -outdataB REGISTERED -cascade -1 -resetmode SYNC -sync_reset -mem_init0 -writemodeA NORMAL -writemodeB NORMAL 
...
architecture Structure of ram_a is
    ...
    attribute MEM_LPC_FILE of ram_a_0_0_0 : label is "ram_a.lpc";
    attribute MEM_INIT_FILE of ram_a_0_0_0 : label is "INIT_ALL_0s";
